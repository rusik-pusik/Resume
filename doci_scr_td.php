...
//die();
                ...
                document.teg5,
                document.Fael_voc
                FROM document WHERE document.name_doc="Технический Департамент"'; //Типа запрос делаем все равно, вначале для всей таблицы
                ...
                if ($name_doc !="" ||!empty($mass3) && !in_array('', $mass3, true)|| $teg1 !="" || $teg2 !="" || $teg3 !="" || $teg4 !="" || $about_doc !="" || $teg5 !="" || $Fael_voc !="")
                {
                    ...
                    document.teg5, 
                    document.Fael_voc
                    FROM document  WHERE (document.name_doc="Технический Департамент") AND'. ($a); // Переписали $query если есть дополнит. условия
                }
