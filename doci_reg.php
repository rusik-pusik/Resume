...
<main class="container">
    ...
    <div class="row ">
        ...
        <form  method="POST" id="myForm" action="doci.php?page=doci_reg">
...
function renderteg1Dropdown($conn) {
    $query = 'SELECT DISTINCT document.teg1 FROM document WHERE (document.name_doc="Регламенты") ORDER BY BINARY teg1';
...
function renderteg2Dropdown($conn, $cellValue) {
    $query1 = 'SELECT DISTINCT document.teg2 FROM document WHERE (document.name_doc="Регламенты" AND document.teg1 = "' . $cellValue . '") ORDER BY BINARY teg2';
...
function renderteg3Dropdown($conn, $cellValue1) {
    $query2 = 'SELECT DISTINCT document.teg3 FROM document WHERE (document.name_doc="Регламенты" AND document.teg2 = "' . $cellValue1 . '") ORDER BY BINARY teg3';
...
function renderteg4Dropdown($conn, $cellValue2) {
    $query3 = 'SELECT DISTINCT document.teg4 FROM document WHERE (document.name_doc="Регламенты" AND document.teg3 = "' . $cellValue2 . '") ORDER BY BINARY teg4';
...
{
    $query4 = 'SELECT DISTINCT document.teg5 FROM document  WHERE (document.name_doc="Регламенты"  AND document.teg4 = "' . $cellValue3 . '")) ORDER BY BINARY teg5';
...
?>
            ...
            ?>
                ...
                function renderFael_vocDropdown($conn) {
                    $query = 'SELECT document.Fael_voc FROM document WHERE (document.name_doc="Регламенты") ORDER BY BINARY Fael_voc';
